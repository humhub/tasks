...
return [
    ...
    '<strong>New</strong> Task' => '<strong>Ny</strong> uppgift',
    '<strong>Task</strong> Overview' => '<strong>Överblick</strong> av uppgift',
    '<strong>Tasks</strong>' => '<strong>Uppgifter</strong>',
    '<strong>Tasks</strong> module configuration' => 'Konfiguration av <strong>Uppgifts</strong>-modul',
