...
return [
  ...
  'Task content ID' => 'Aufgaben Inhaltskennung',
  ...
  '{displayName} completed task "{contentTitle}".' => '{displayName} hat die Aufgabe "{contentTitle}" abgeschlossen.',
  ...
  '{displayName} is task creator' => '{displayName} ist Aufgaben-Ersteller',
  '{displayName} reset task "{contentTitle}".' => '{displayName} hat die Aufgabe "{contentTitle}" zurückgesetzt.',
  '{displayName} reviewed task "{contentTitle}".' => '{displayName} hat die Aufgabe "{contentTitle}" überprüft.',
  '{displayName} works on task "{contentTitle}".' => '{displayName} arbeitet an der Aufgabe "{contentTitle}".',
