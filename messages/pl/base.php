...
return [
    ...
    '<strong>New</strong> Task' => '<strong>Nowe</strong> Zadanie',
    '<strong>Task</strong> Overview' => 'Przegląd <strong>Zadań</strong>',
    '<strong>Tasks</strong>' => '<strong>Zadania</strong>',
    '<strong>Tasks</strong> module configuration' => 'Konfiguracja modułu <strong>zadań</strong>',
    '<strong>Your</strong> tasks' => '<strong>Twoje</strong> zadania',
    'A widget is an element added to to the sidebar of a stream. In this case it provides users with a short overview of their tasks.' => 'Widżet to element dodawany w pasku bocznym strumienia. W tym wypadku pozwala użytkownikom na podgląd ich zadań.',
    ...
    'Add entry to main navigation' => 'Dodaj element do menu nawigacyjnego',
    ...
    'Choose if you want the module to appear in the main navigation.' => 'Wybierz czy moduł ma się pojawić w głównej nawigacji.',
    'Close' => 'Zamknij',
    'Color' => 'Kolor',
    'Completed' => 'Wykonane',
    'Completed lists' => 'Lista wykonanych',
    'Configure the Tasks module to meet your specific requirements and needs. You can define individual settings and for instance decide whether a widget is displayed.' => 'Konfiguruj moduł zadań aby dostosować go do własnych potrzeb. Można np. ustawić czy widżet ma być wyświetlany.',
    ...
    'ID' => 'ID',
    'If empty any user can complete the task.' => 'O ile użytkownik może zakończyć zadanie.',
    ...
    'Maximum number of entries in widget' => 'Maksymalna liczba elementów w widżecie',
    'Module Widget' => 'Widżet modułu',
    'New list or search' => 'Nowa lista lub wyszukiwanie',
    ...
    'Responsible users' => 'Odpowiedzialni użytkownicy',
    'Review by responsible user required' => 'Wymagany przegląd przez innych użytkowników',
    'Scheduling' => 'Planowanie',
    'Show widget in Spaces' => 'Pokaż widżet w strefach',
    'Show widget on Dashboard' => 'Pokaż widżet w kokpicie',
    ...
    'Task content ID' => 'ID zawartości zadania',
    ...
    '{displayName} is task creator' => '{displayName} jest twórcą zadania',
