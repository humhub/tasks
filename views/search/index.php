...
$createUrl = $contentContainer->createUrl('/tasks/task/edit');
$filterUrl = $contentContainer->createUrl('/tasks/search/filter-tasks');
...
<div class="panel panel-default task-overview">
    ...
    <div id="filter-tasks-list" class="panel-body">
        <?= TaskSearchList::widget(['filter' => $filter, 'canEdit' => $canEdit]) ?>
    </div>
</div>
